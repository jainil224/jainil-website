...
export default function VimeoHero() {
    ...
    const colors = [
        ...
        [0.0980, 0.0980, 0.4392], // #191970
        [0.6902, 0.7686, 0.8706], // #b0c4de
        [0.8078, 0.0706, 0.0706], // #ce1212
        [0.7804, 0.6784, 0.4157], // #c7ad6a
        [0.0000, 0.5922, 0.6549], // #0097a7
        [0.4784, 0.2314, 0.2745], // #7a3b46
    ];
