...
export default function Footer() {
    useEffect(() => {
        ...
        const wiggleTargets = [
            ...
            { selector: '.footer-resume-link', key: 'socials' },
        ...
        <div className="footer-inner">
            <div className="footer-top">
                ...
                <div className="footer-column">
                    <span className="footer-badge">need a developer?</span>
                    <h3>{"i'm here.    :)"}</h3>
                </div>
                {/* Office */}
                <div className="footer-column">
                ...
                {/* Resume */}
                <div className="footer-column">
                    <span className="footer-badge">credentials</span>
                    <a href="/resume_jainil.pdf" target="_blank" rel="noopener noreferrer" className="footer-resume-link">
                        download resume
                    </a>
                    <p className="footer-note" style={{ marginTop: '0px' }}>view professional history, skill sets, and experience records.</p>
                </div>
                {/* Contact */}
                <div className="footer-column">
                    <span className="footer-badge">contact</span>
                    <a href="mailto:jainil11199@gmail.com" className="footer-email">jainil11199@gmail.com</a>
            ...
            <div className="footer-bottom">
                <div className="footer-big-text">
                    <span className="footer-logo__text" style={{ fontFamily: 'Epilogue', fontWeight: '900', fontSize: 'clamp(5rem, 15vw, 15rem)', letterSpacing: '-6px', textTransform: 'lowercase', color: 'currentColor', display: 'block', textAlign: 'center', lineHeight: '0.8', width: '100%', userSelect: 'none', cursor: 'default' }}>
                        jainil.
                    </span>
                </div>
                        ...
                        <div className="credits-box">
                            <div className="credits-content">
                                <div className="credits-item credit-wiggle">
                                    ...
                                    <div className="overflow-wrapper"><a href="#" className="credits-name" data-wiggle-target="true">Jainil</a></div>
                                </div>
                                <div className="credits-item credit-wiggle">
